...
class rtmsg_base(nlflags):
    ...
    class seg6_local_encap_info(nla):

        __slots__ = ()

        nla_map = (('SEG6_LOCAL_UNSPEC', 'none'),
                   ('SEG6_LOCAL_ACTION', 'uint32'),
                   ('SEG6_LOCAL_SRH', 'ipv6_sr_hdr'),
                   ('SEG6_LOCAL_TABLE', 'uint32'),
                   ('SEG6_LOCAL_NH4', 'uint32'),
                   ('SEG6_LOCAL_NH6', 'ip6addr'),
                   ('SEG6_LOCAL_IIF', 'uint32'),
                   ('SEG6_LOCAL_OIF', 'uint32'),
    ...
    encaps = {LWTUNNEL_ENCAP_MPLS: mpls_encap_info,
              ...
              LWTUNNEL_ENCAP_SEG6_LOCAL: seg6_local_encap_info}
